...
['label' => 'Pending Fine Amount (₱)', 'value' => number_format($pendingFineAmount, 2), 'data-placement' => 'bottom', 'data-title' => 'Total amount of pending fine', 'icon' => 'fas fa-hourglass-half', 'bg' => 'bg-warning'],
['label' => 'Paid Fine Amount (₱)', 'value' => number_format($paidFineAmount, 2), 'data-placement' => 'bottom', 'data-title' => 'Total amount of paid fine', 'icon' => 'fas fa-coins', 'bg' => 'bg-info'],
