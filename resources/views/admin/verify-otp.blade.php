...
<div class="hero_area">
    <div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh;">
        ...
        <div class="card shadow-lg p-4" style="width: 420px; border-radius: 15px;">
            ...
            <h4 class="text-center mb-3 font-weight-bold">Two-Factor Authentication</h4>
            ...
            <form action="{{ route('admin.otp.submit') }}" method="POST" id="otpForm">
                @csrf
                ...
                <input type="hidden" name="otp_code" id="otp_final">
